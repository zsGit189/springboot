...
_350(_35d,_35e);
opts.onAdd.call(_35d,_35e.title,_35e.login);
if(_35e.selected){
_360(_35d,_35e.login);
}
};
...
if(item){
item.width=_640;
var rule=this.getRule(item.login);
if(rule){
...
var _76e=_767(_76c,_76d.login!=undefined?_76d.login:_76d.id);
...
view.insertRow.call(view,_789,_78a.login,_78a.row);
_78b.push(_78a.row);
...
var row=opts.finder.getRow(_790,_791.login);
var _793=false;
_791.row=_791.row||{};
...
opts.view.updateRow.call(opts.view,_790,_791.login,_791.row);
}
};
function _795(_796){
...
var tr=opts.finder.getTr(_7ae,(_7af.login!=undefined?_7af.login:_7af.id),_7af.type);
if(!tr.length){
return;
}
